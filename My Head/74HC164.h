...
//红灯显示
#define COM_1_1 (IO_vSetPin(IO_P10_15))//(P10_OUT_P13 = 1)
#define COM_1_0 (IO_vResetPin(IO_P10_15))//(P10_OUT_P13 = 0)
#define COM_COM_1 (IO_vTogglePin(IO_P10_15))//(P10_OUT_P10=~P10_OUT_P10)

//数字显示开关
#define COM_2_1 (IO_vSetPin(IO_P10_13))//(P10_OUT_P15 = 1)
