...
void ADC1_vInit(void)
{
  ...
  ADC1_CHCTR4    =  0x2004;      // load channel control register
  ...
  ADC1_RCR0      =  0x0040;      // load result control register 0
  ...
  ADC1_RCR1      =  0x0040;      // load result control register 1
  ...
  ADC1_RCR2      =  0x0040;      // load result control register 2
  ...
  ADC1_RCR3      =  0x0040;      // load result control register 3
  ...
  ADC1_RCR4      =  0x0040;      // load result control register 4
  ...
  ADC1_RCR5      =  0x0040;      // load result control register 5
  ...
  ADC1_RCR6      =  0x0040;      // load result control register 6
  ...
  ADC1_RCR7      =  0x0040;      // load result control register 7
  ...
  P15_DIDIS      =  0x0031;      // Port 15 Digital input disable register
...
//****************************************************************************
// @Function      void ADC1_vStartSeq0ReqChNum(uint8 ubExtTrg, uint8 
