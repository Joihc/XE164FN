...
void ADC0_vInit(void)
{
  ...
  ADC0_CHCTR0    =  0x3004;      // load channel control register
  ...
  ADC0_CHCTR2    =  0x0004;      // load channel control register
  ...
  ADC0_CHCTR3    =  0x4004;      // load channel control register
  ...
  ADC0_CHCTR4    =  0x5004;      // load channel control register
  ...
  ADC0_CHCTR5    =  0x7004;      // load channel control register
  ...
  ADC0_CHCTR8    =  0x6004;      // load channel control register
  ...
  ADC0_RCR1      =  0x0040;      // load result control register 1
  ...
  ADC0_RCR2      =  0x0040;      // load result control register 2
  ...
  ADC0_RCR3      =  0x0040;      // load result control register 3
  ...
  ADC0_RCR4      =  0x0040;      // load result control register 4
  ...
  ADC0_RCR5      =  0x0040;      // load result control register 5
  ...
  ADC0_RCR6      =  0x0040;      // load result control register 6
  ...
  ADC0_RCR7      =  0x0040;      // load result control register 7
  ...
  P5_DIDIS       =  0x013D;      // Port 5 Digital input disable register
...
//****************************************************************************
// @Function      void ADC0_vStartSeq0ReqChNum(uint8 ubExtTrg, uint8 
//                ubEnIntr, uint8 ubRFill, uint8 ubChannelNum) 
//
//----------------------------------------------------------------------------
...
void ADC0_vStartSeq0ReqChNum(uint8 ubExtTrg, uint8 ubEnIntr, uint8 ubRFill, uint8 ubChannelNum)
{
